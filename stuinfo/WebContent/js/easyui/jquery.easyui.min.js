...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"此项必填！",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入正确的电子邮件地址！"},url:{validator:function(_409){
...
},message:"请输入正确的URL！"},length:{validator:function(_40a,_40b){
var len=$.trim(_40a).length;
return len>=_40b[0]&&len<=_40b[1];
},message:"请输入 {0}和{1}之间的值！"},remote:{validator:function(_40c,_40d){
var data={};
data[_40d[1]]=_40c;
