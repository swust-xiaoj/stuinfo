...
<p align="center" class="title">学生信息导出</p>

<div id="data_table" align="center">
    <form name="data" action="downdeal.jsp" method="post" onSubmit="return cheak()">
 <tr><td><input style="color:blue " align="center" type="submit" value="导出" /></td></tr>
		...
		if(stuId==null){
			try{
				...
				%></td><td width="100" height="20"  align="center"><%
					...
					rst.close();
					stmt2.close();
				%></td><td width="100" height="20"  align="center"><input type="checkbox" name="check" value=<%=checks%> /></td></tr>	
				<%
				}
				rs.close(); 
				stmt.close();
			...
			try{
				...
				stmt.close();
				conn.close();
				response.sendRedirect("putoutstu.jsp");
			}catch(SQLException e){
				out.print(e.getMessage());
