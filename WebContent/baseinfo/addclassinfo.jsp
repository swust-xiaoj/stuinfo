...
<head>
	...
	<title>程序设计综合训练--示例--班级信息录入</title>
	...
	<script type="text/javascript">	
		function check(){
			if(document.stuform.className.value.trim()==""){
				alert("班级信息没有填写!");
				document.stuform.className.focus();
				return false;
			}
...
<body>
	<p align="center" class="title">班级基本信息录入</p>
	<table border="0" align="center">
	<tr><td width="170"></td><td width="830">
	<form name="stuform" action="inputclass.jsp" method="post" onSubmit="return check()"><table width="720">
		<tr><td width="300" align="right">班级：</td><td width="420"><input  type="text" name="className" class="easyui-validatebox" /></td></tr>
